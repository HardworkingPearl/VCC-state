...
def get_lightning_module(model_type: str, data_config: dict, model_config: dict, training_config: dict, var_dims: dict):
    ...
    # QH: here to add the models you want to try
    ...
    if model_type.lower() == "embedsum":
        ...
        from ...tx.models.xgboost import XGBoosModel
        ...
        from ...tx.models.tabpfn import TabPFNModel
    ...
    elif model_type.lower() == "tabicl":
        from ...tx.models.tabicl_transition import TabICLModel
